...
$projectUri = 'https://www.nirsoft.net/utils/wifi_diagnostics_view.html'
$checksumsUrl = 'https://www.nirsoft.net/hash_check/?software=wifidiagnosticsview'
$userAgent = 'Update checker of Chocolatey Community Package ''wifidiagnosticsview'''
...
function global:au_SearchReplace {
    @{
        ...
        "$($Latest.PackageName).nuspec" = @{
            ...
            "<copyright>[^<]*</copyright>" = "<copyright>Copyright (c) $(Get-Date -Format yyyy) Nir Sofer</copyright>"
        }
